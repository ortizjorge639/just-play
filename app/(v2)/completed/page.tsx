...
const GAMES: GameData[] = [
  { id: 1, title: 'Elden Ring',      genre: 'rpg',        color: '#7B2FBE', floor: 0 },
  { id: 2, title: 'Hollow Knight',   genre: 'adventure',  color: '#1A5C3A', floor: 0 },
  { id: 3, title: 'Celeste',         genre: 'platformer', color: '#1565C0', floor: 0 },
  { id: 4, title: 'Hades',           genre: 'action',     color: '#8B2000', floor: 0 },
  { id: 5, title: 'Disco Elysium',   genre: 'rpg',        color: '#4A1A8E', floor: 1 },
  { id: 6, title: 'Undertale',       genre: 'adventure',  color: '#B84080', floor: 1 },
  { id: 7, title: 'Into the Breach', genre: 'action',     color: '#8B4500', floor: 0 },
  { id: 8, title: 'Stardew Valley',  genre: 'sim',        color: '#1B5E20', floor: 0 },
  { id: 9, title: 'Cuphead',         genre: 'action',     color: '#B85A00', floor: 1 },
];
...
export default function CompletedPage() {
  ...
  // ── layout ──────────────────────────────────────────────────────────────
  return (
    <div style={{ width: '100%', minHeight: '100vh', backgroundColor: '#2A1810', display: 'flex', flexDirection: 'column', fontFamily: 'Nunito, sans-serif', position: 'relative', overflow: 'hidden', paddingBottom: 72 }}>
      <style>{`
