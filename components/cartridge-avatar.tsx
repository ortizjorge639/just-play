...
const GENRE_GRADIENTS: Record<string, string> = {
  ...
  adventure: 'linear-gradient(135deg,#0D3B2E,#1A8C5A,#7FD99A)',
  platformer: 'linear-gradient(135deg,#1565C0,#42A5F5,#90CAF9)',
  action: 'linear-gradient(135deg,#7B1F00,#D4460A,#FFB74D)',
  horror: 'linear-gradient(135deg,#1A0A0A,#5C1A1A,#8B0000)',
  rhythm: 'linear-gradient(135deg,#4A0030,#B01060,#FF4081)',
  sim: 'linear-gradient(135deg,#1B4020,#4CAF50,#A5D6A7)',
}
...
export function genreGradient(genres?: string[] | null): string {
  for (const g of genres ?? []) {
    const key = GENRE_KEYS[g.toLowerCase().trim()]
    if (key) return GENRE_GRADIENTS[key]
  }
  return GENRE_GRADIENTS.action
}
